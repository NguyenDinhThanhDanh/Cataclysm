...
/**
 * Class DeplacementVersAmis
 */
public class DeplacementVersAmis extends AbstractDeplacement {

  public DeplacementVersAmis() {
	 super.setNext(new DeplacementVersArbre());
	 super.setType("Amis Proche");
  }
